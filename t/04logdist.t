...
use Mojolicious::Plugin::LogDispatch;
...
ok( $dispatch, "created Mojolicious::Plugin::LogDispatch object" );
...
# Log::Dispatch multiple callbacks
{
    ...
    my $dispatch = Mojolicious::Plugin::LogDispatch->new( callbacks => [ $reverse, $uc ] );
...
# test level paramter to callbacks
{
    ...
    my $dispatch = Mojolicious::Plugin::LogDispatch->new( callbacks => $level );
